 ...
 * Description: This class will hold all the information necessary about an event
 *
 */

public class Event {

    /*event details declaration*/
	private int color;
	private String name;
	...
	/*setter and getters for the event details*/
    ...
    public void setStartMinute(int minute){this.startMinute= minute; }
